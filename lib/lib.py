...
translate = {
    ...
    "ExsS": {"full": "주격접미어가 있는 존재어", "abbr": "주존재"},
    "Exst": {"full": "존재어", "abbr": "존재"},
    "Frnt": {"full": "전방도치어", "abbr": "전도치"},
    "Intj": {"full": "감탄사", "abbr": "감탄"},
    "IntS": {"full": "주격접미어가 있는 감탄사", "abbr": "주감탄"},
    "Loca": {"full": "장소격", "abbr": "장소"},
    "Modi": {"full": "수식어", "abbr": "수식"},
    "ModS": {"full": "주격접미어가 있는 수식어", "abbr": "주수식"},
    "NCop": {"full": "비존재어", "abbr": "비존"},
    "NCoS": {"full": "주격접미어가 있는 비존재어", "abbr": "주비존"},
    "Nega": {"full": "부정어", "abbr": "부정"},
    "Objc": {"full": "목적어", "abbr": "목적"},
    "PrAd": {"full": "서술격 부가어", "abbr": "서술부"},
    "PrcS": {"full": "주격접미어가 있는 서술격 보어", "abbr": "주서술부"},
    "PreC": {"full": "서술격 보어", "abbr": "서술부"},
    "Pred": {"full": "서술어", "abbr": "서술"},
    "PreO": {"full": "목적격 접미어가 있는 서술어", "abbr": "목서술"},
    "PreS": {"full": "주격 접미어가 있는 서술어", "abbr": "주서술"},
