...
translate = {
    ...
    "hif": {"full": "히필(H)", "abbr": "히필"},
    "hit": {"full": "히트파엘(H)", "abbr": "히트파엘"},
    "htpo": {"full": "히트포엘(H)", "abbr": "히트포엘"},
    "hof": {"full": "호팔(H)", "abbr": "호팔"},
    "nif": {"full": "니팔(H)", "abbr": "니팔"},
    "piel": {"full": "피엘(H)", "abbr": "피엘"},
    "poal": {"full": "포알(H)", "abbr": "포알"},
    "poel": {"full": "포엘(H)", "abbr": "포엘"},
    "pual": {"full": "푸알(H)", "abbr": "푸알"},
    "qal": {"full": "칼(H)", "abbr": "칼"},
